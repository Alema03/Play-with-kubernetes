...
We welcome issues and pull requests for either adding a new tutorial, or fixing a problem with an existing tutorial. This is a repository for tutorials that use Kubernetes on Docker as much as possible. So if there’s a Docker tool for what you’re describing, please use that.
...
- The [Moby Project contribution guidelines](https://github.com/moby/moby/blob/master/CONTRIBUTING.md).
